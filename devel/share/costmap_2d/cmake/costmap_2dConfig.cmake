...
if("TRUE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /ws/src/navigation/costmap_2d)
  set(costmap_2d_DEVEL_PREFIX /ws/devel)
  ...
  set(costmap_2d_INSTALL_PREFIX /ws/install)
...
if(NOT "/ws/devel/include;/ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(costmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/ws/devel/include;/ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws/src/navigation/costmap_2d/${idir}'.  ${_report}")
    endif()
