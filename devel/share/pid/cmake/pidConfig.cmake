...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /ws/src/pid)
  set(pid_DEVEL_PREFIX /ws/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /ws/install)
...
if(NOT "/ws/devel/include;/ws/src/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/ws/devel/include;/ws/src/pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws/src/pid/${idir}'.  ${_report}")
    endif()
