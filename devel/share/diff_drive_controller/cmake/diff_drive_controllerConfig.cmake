...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /ws/src/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /ws/devel)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /ws/install)
...
if(NOT "/ws/devel/include;/ws/src/diff_drive_controller/include;/usr/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/ws/devel/include;/ws/src/diff_drive_controller/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws/src/diff_drive_controller/${idir}'.  ${_report}")
    endif()
