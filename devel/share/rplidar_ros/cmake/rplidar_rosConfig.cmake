...
if("TRUE" STREQUAL "TRUE")
  set(rplidar_ros_SOURCE_PREFIX /ws/src/rplidar_ros)
  set(rplidar_ros_DEVEL_PREFIX /ws/devel)
  ...
  set(rplidar_ros_INSTALL_PREFIX /ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws/src/rplidar_ros/${idir}'.  ${_report}")
    endif()
