...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/ws/devel/include;/ws/src/diff_drive_controller/include;/usr/include".split(';') if "/ws/devel/include;/ws/src/diff_drive_controller/include;/usr/include" != "" else []
