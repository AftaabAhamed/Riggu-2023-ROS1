...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/ws/devel/include;/ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include".split(';') if "/ws/devel/include;/ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include" != "" else []
