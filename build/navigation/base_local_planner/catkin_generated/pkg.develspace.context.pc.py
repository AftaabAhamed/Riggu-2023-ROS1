...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/ws/devel/include;/ws/src/navigation/base_local_planner/include".split(';') if "/ws/devel/include;/ws/src/navigation/base_local_planner/include" != "" else []
